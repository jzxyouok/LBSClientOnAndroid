...
public class MeasureTree extends Activity 
implements SensorEventListener,SurfaceHolder.Callback,View.OnClickListener
{
    ...
    private void initdb() {
		...
		mySQLiteOpenHelper = new MySQLiteOpenHelper(MeasureTree.this);
	}
	...
	public void onClick(View paramView) {
		...
		case R.id.top:
			...
			Intent intent=new Intent(MeasureTree.this, TreeHighMesure.class);
	...
	private void makeDialog(){
		...
		this.mInputHeightET.setText(MeasureTree.this.L+"");
		while (true)
	    {
			...
			localBuilder.setPositiveButton(R.string.ok,new DialogInterface.OnClickListener(){
				...
				public void onClick(DialogInterface dialog, int which) {
					// TODO Auto-generated method stub
					String str = MeasureTree.this.mInputHeightET.getText().toString();
					double d = Double.valueOf(str).doubleValue();
					MeasureTree.this.L = MeasureTree.this.setFormat(d);
				}
